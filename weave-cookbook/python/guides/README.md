...
Ordered walkthroughs, one new idea each, run from the `python/` directory.
...
| # | Guide | One new idea |
| --- | --- | --- |
| 04 | [Version objects](04-versioning/README.md) | `weave.publish` + `weave.ref(...).get()` give any object an immutable history |
